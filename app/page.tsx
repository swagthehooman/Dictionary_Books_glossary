...
export default function Home() {
  return (
    <main className={`w-full h-full`}>
      <img src="/images/paperCutout.jpeg" alt="background" className="fixed left-0 top-0 h-full w-[50%] -z-10" />
      <div className="fixed right-0 top-0 h-full w-[50%] grid place-content-center gap-4">
